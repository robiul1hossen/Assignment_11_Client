    ...
    <div>
      <div className="mb-10 mt-20">
        <p className="text-center">
          <small>Clients words</small>
        </p>
        <h2 className="text-center text-4xl font-semibold  my-5">What our clients say</h2>
      ...
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full">
          <div className="ms-7 flex items-center w-1/2">
          ...
          <img src="https://i.ibb.co/10QWDs5/download.png" className="w-1/2" />
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <img src="https://i.ibb.co/THxHgRj/choose.png" alt="Second slide" className="w-1/2" />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
        ...
        <div id="slide4" className="carousel-item relative w-full">
          ...
          <img src="https://i.ibb.co/whkZ5Pb/image6.png" className="w-1/2" />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#slide3" className="btn btn-circle">
              ❮
            </a>
